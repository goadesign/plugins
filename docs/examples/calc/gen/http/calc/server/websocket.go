...
// SendWithContext streams instances of "int" to the "add" endpoint websocket
// connection with context.
func (s *AddServerStream) SendWithContext(ctx context.Context, v int) error {
	return s.Send(v)
}
...
// RecvWithContext reads instances of "calc.AddStreamingPayload" from the "add"
// endpoint websocket connection with context.
func (s *AddServerStream) RecvWithContext(ctx context.Context) (*calc.AddStreamingPayload, error) {
	return s.Recv()
}
