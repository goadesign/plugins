...
// RecvWithContext reads instances of "int" from the "add" endpoint websocket
// connection with context.
func (s *AddClientStream) RecvWithContext(ctx context.Context) (int, error) {
	return s.Recv()
}
...
// SendWithContext streams instances of "calc.AddStreamingPayload" to the "add"
// endpoint websocket connection with context.
func (s *AddClientStream) SendWithContext(ctx context.Context, v *calc.AddStreamingPayload) error {
	return s.Send(v)
}
