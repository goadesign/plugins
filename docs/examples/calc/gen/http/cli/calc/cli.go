...
func UsageExamples() string {
	return os.Args[0] + " " + "calc add --left 1828520165265779840 --right 6322633713974661021" + "\n" +
		""
}
...
func calcUsage() {
	fmt.Fprintln(os.Stderr, `The calc service performs additions on numbers`)
...
func calcAddUsage() {
	// Header with flags
	fmt.Fprintf(os.Stderr, "%s [flags] calc add", os.Args[0])
	fmt.Fprint(os.Stderr, " -left INT")
	fmt.Fprint(os.Stderr, " -right INT")
	fmt.Fprintln(os.Stderr)
	...
	// Flags list
	fmt.Fprintln(os.Stderr, `    -left INT: Left operand`)
	fmt.Fprintln(os.Stderr, `    -right INT: Right operand`)

	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "calc add --left 1828520165265779840 --right 6322633713974661021")
}
