...
func UsageExamples() string {
	return os.Args[0] + ` calc add --left 3793862871819669726 --right 8399553735696626949` + "\n" +
		""
}
...
func calcAddUsage() {
	fmt.Fprintf(os.Stderr, `%[1]s [flags] calc add -left INT -right INT
...
Example:
    %[1]s calc add --left 3793862871819669726 --right 8399553735696626949
`, os.Args[0])
}
