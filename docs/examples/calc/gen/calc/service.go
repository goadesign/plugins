...
type AddServerStream interface {
	...
	// RecvWithContext reads instances of "AddStreamingPayload" from the stream
	// with context.
	RecvWithContext(context.Context) (*AddStreamingPayload, error)
...
type AddClientStream interface {
	...
	// SendWithContext streams instances of "AddStreamingPayload" with context.
	SendWithContext(context.Context, *AddStreamingPayload) error
