...
import (
	...
	sommelierc "goa.design/plugins/goakit/examples/cellar/gen/http/sommelier/client"
	storagec "goa.design/plugins/goakit/examples/cellar/gen/http/storage/client"
)
