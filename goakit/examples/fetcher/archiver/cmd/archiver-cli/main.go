...
func writeEndpointResult(ctx context.Context, stdout io.Writer, endpoint endpoint.Endpoint, payload any) error {
...
Usage:
    ...
    -url URL:    specify service URL overriding host URL (http://localhost:80)
