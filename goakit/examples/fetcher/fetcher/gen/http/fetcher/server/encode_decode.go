...
// endpoint.
func DecodeFetchRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*fetcher.FetchPayload, error) {
	return func(r *http.Request) (*fetcher.FetchPayload, error) {
		var (
			url_ string
			err  error
