...
import (
	...
	calcc "goa.design/plugins/v3/cors/examples/calc/gen/http/calc/client"
)
...
func calcUsage() {
	fmt.Fprintln(os.Stderr, `The calc service exposes public endpoints that defines CORS policy.`)
