...
import (
	...
	calculatorsvr "goa.design/plugins/v3/testing/examples/calculator/gen/grpc/calculator/server"
...
func handleGRPCServer(ctx context.Context, u *url.URL, calculatorEndpoints *calculator.Endpoints, wg *sync.WaitGroup, errc chan error, dbg bool) {
	...
	{
		calculatorServer = calculatorsvr.New(calculatorEndpoints, nil, nil)
	}
	...
	calculatorpb.RegisterCalculatorServer(srv, calculatorServer)
