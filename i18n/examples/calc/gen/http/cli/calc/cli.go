...
func calcUsage() {
	fmt.Fprintln(os.Stderr, `The calc service exposes public endpoints to do basic mathematical calculations.`)
	fmt.Fprintf(os.Stderr, "Usage:\n    %s [globalflags] calc COMMAND [flags]\n\n", os.Args[0])
	fmt.Fprintln(os.Stderr, "COMMAND:")
	fmt.Fprintln(os.Stderr, `    add: Add adds up the two integer parameters and returns the results.`)
...
func calcAddUsage() {
	...
	// Description
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, `Add adds up the two integer parameters and returns the results.`)

	// Flags list
	fmt.Fprintln(os.Stderr, `    -a INT: `)
	fmt.Fprintln(os.Stderr, `    -b INT: `)
